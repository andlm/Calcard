...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                .title("Spring Boot CALCARD REST API")
                .description("\"Spring Boot CALCARD REST API\"")
                .version("1.0.0")
                .license("Apache License Version 2.0")
                .licenseUrl("https://www.apache.org/licenses/LICENSE-2.0\"")
                .contact(new Contact("Anderson", "http://localhost:8080/portalCalcardRestService/", "anderson@calcard.com.br"))
                .build();
    }
    @Override
